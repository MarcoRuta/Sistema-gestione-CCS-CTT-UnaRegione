...
public class RicercaSaccaTest {
	...
	*/
	...
	/**
	*Test che dovrebbe restituire la Sacca del tipo compatibile a quello ricercato
	*"CTT001-00000007"
	*/
	@Test
	public void test3() {
	...
	*/
	...
	/**
	*Test che non dovrebbe restituire nessuna sacca in quanto sono state esaurite sia quelle del tipo cercato, sia le compatibili
	*/
	@Test
	public void test6() {
		assertEquals(null, oper.ricercaSaccaLocale(GruppoSanguigno.Ap, LocalDate.of(2010,04,10), "Mr. Damme tutto"));
	}
