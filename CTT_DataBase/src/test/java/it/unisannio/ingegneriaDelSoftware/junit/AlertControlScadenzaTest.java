...
public class AlertControlScadenzaTest {
	...
	@BeforeClass public static void populateDBSacche() {
	    	...
	    	localDataScadenza = LocalDate.of(2021,05,16);
	    	prenotato = false;
	    	sacca = new Sacca(gs, localDataProduzione, localDataScadenza, prenotato);
	    	listaSacche.add(sacca);
	    	...
	    	localDataScadenza = LocalDate.of(2021,05,15);
	    	prenotato = true;
	    	sacca = new Sacca(gs, localDataProduzione, localDataScadenza, prenotato);
	    	listaSacche.add(sacca);
	...
	/**
	*Test che dovrebbe restituire una lista con 2 Sacche che stanno per scadere
	*/
	@Test	
	public void test1(){  	
		assertEquals(2, ctt.alertControlScadenza().size());
	}
