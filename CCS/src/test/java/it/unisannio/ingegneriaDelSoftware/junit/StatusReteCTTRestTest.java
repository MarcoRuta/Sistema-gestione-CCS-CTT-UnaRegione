...
public class StatusReteCTTRestTest {

    static String token = null;
    Client client = ClientBuilder.newClient();
    WebTarget StatusReteCTT = client.target("http://127.0.0.1:8080/rest/CCS/statusReteCtt");
    ...
    /** Test per il metodo rest/CCS/statusReteCtt dell'amministratoreCCS, va a buon fine
     * @throws EntityAlreadyExistsException

    @Test
    public void testCorretto() throws EntityAlreadyExistsException{
        Response responseReport = StatusReteCTT.request().header(HttpHeaders.AUTHORIZATION, "Basic "+token).get();
